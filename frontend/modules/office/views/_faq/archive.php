...
?>
			...
			?>
				<article id="faq-<?php echo $faq->id; ?>" class="piece-of-faq" itemscope itemtype="http://schema.org/Article">
					<div class="row">

						<div class="col-sm-12 faq-title">
							<a href="<?php echo Url::to(['/office/faq/view/', 'id' => $faq->id]); ?>" title="Просмотреть справку <?php echo $faq->title; ?>">
						...
						<div class="col-sm-3 col-md-2 faq-footer">
							<div class="row">
								<div class="col-xs-6 text-right">
									<a class="btn btn-xs btn-success" href="<?php echo Url::to(['/office/faq/view/', 'id' => $faq->id]); ?>" title="Просмотреть справку <?php echo $faq->title; ?>">
										Подробнее
									</a>
								</div>
							</div><!-- /.row -->
