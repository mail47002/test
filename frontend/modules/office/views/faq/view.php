...
$this->title = 'Справка: ' . $model->title;
...
// Category
$category = '<span class="text-'.$role->color.'" data-toggle="tooltip" data-placement="top" title="'.$role->name.'"><span class="glyphicon glyphicon-'.$role->ico.'" aria-hidden="true"></span></span>';
