...
$this->title = $flag=='gift'?'Подарок':'Бонус';
$this->title .= ' ' .$model->name;
$this->params['breadcrumbs'][] = $this->title;
?>

		<article class="office-bonus-product-card" itemscope itemtype="http://schema.org/Article">
						...
						<div class="col-sm-9 col-sm-9 col-md-9 price-block">
							<div class="row">
								...
								<div class="col-xs-6 col-md-3">
									<span class="text-primary gift-value"><?php echo $flag=='gift'?$model->gift:$model->bonus; ?></span>
								...
								<div class="col-xs-6 col-md-4 col-lg-3">
									<a class="btn btn-success center-block" href="<?php echo Url::to(['/office/gifts/order/', 'id' => $model->id]); ?>">Заказать</a>
								</div>
								<?php
									}
								?>
		...
		</article><!-- /.office-bonus-product-card -->