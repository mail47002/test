...
?>
		...
		<article class="office-bonus-index" itemscope itemtype="http://schema.org/Article">
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-7">
									...
									<div class="row btn-margin">
										<div class="col-xs-6">
											<a class="btn btn-xs btn-primary center-block" href="<?php echo Url::to(['/office/bonus/product-card-bonus', 'id' => $product->id]); ?>">
												Подробнее
											</a>
										</div>
										<?php
