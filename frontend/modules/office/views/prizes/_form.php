...
<div class="prizes-form">
		...
		<?php $form = ActiveForm::begin(['id' => 'form-products-register','options' => ['enctype'=>'multipart/form-data', 'class' => 'products-register', 'name' => 'products-register']]); ?>
		...
		<div class="row">
					...
					<div class="col-sm-8">
							...
							<?= $form->field($model, 'excerpt')->widget(CKEditor::className(), [
								'editorOptions' =>
									ElFinder::ckeditorOptions('prizes',[
										'preset' => 'basic',
										'uiColor' => '#b895c2',
									]),
							]) ?>
					...
					<div class="col-sm-4">
						<div class="alert alert-warning">
							...
							<div class="form-group">
								<span class="lead text-white">Видимость подарка</span>
							</div>
					...
					<div class="col-sm-4">
						<div class="well well-lg">
							...
							<div class="form-group">
								<span class="lead text-success">Категория подарка</span>
							</div>
					...
					<div class="col-sm-4">
						<div class="well well-lg">
							...
							<div class="form-group">
								<span class="lead text-success">Миниатюра подарка</span>
							</div>


							<?= $form->field($model, 'img')->widget(InputFile::className(), [
								'language'      => 'ru',
								'controller'    => 'prizes', // вставляем название контроллера, по умолчанию равен elfinder
