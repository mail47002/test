...
$this->title = 'Падарок: ' .$model->name;
$this->params['breadcrumbs'][] = $this->title;
?>

		<article class="office-prizes-single" itemscope itemtype="http://schema.org/Article">
						...
						<div class="col-sm-9 col-sm-9 col-md-9 price-block">
							<div class="row">
								...
								<div class="col-xs-12 col-md-6">
									<span class="text-primary gift-value"><?php echo $model->gift; ?></span>
								...
								?>
								<div class="col-xs-12 col-md-6">
									<a class="btn btn-primary center-block" href="<?php echo $model->url; ?>" title="Просмотреть бонус на сайте производителя">
										На сайте<span class="visible-lg-inline"> производителя</span>
									</a>
								</div>
								<?php
									}
