...
<div class="prizes-index">
    ...
    <span class="control-btn">
        <?= Html::a(Html::tag('span','',['class' => 'glyphicon glyphicon-plus', 'aria-hidden' => 'true']) . ' Создать подарок', ['create'], ['class' => 'btn btn-success']) ?>
    </span>
        ...
        'columns' => [
			...
			[
				...
				'value' => function($data){
					return Html::a(
						$data->name,
						Url::to(['/office/prizes/view/', 'id' => $data->id]),
						[
							'data-toggle' => 'tooltip',
							'data-placement' => 'top',
							'title' => 'Просмотреть подарок',
						]
					);
				}
			],
			...
			[
				...
				'buttons' => [
					...
					'update' => function ($url,$model,$key) {
						...
						$url, ['class' => 'action-link', 'data-toggle' => 'tooltip', 'data-placement' => 'top', 'title' => 'Изменить подарок' ]);
					},
